...
class TestAdd(unittest.TestCase): 
    def test1(self):
        # Check that calling 'add(2, 3)' returns 5.
        self.assertEqual(add(2, 3), 5)
        # Check that calling 'add(10, 20)' returns 30.
        self.assertEqual(add(10, 20), 30)
        # Check that calling 'add(-5, 10)' returns 5.
        self.assertEqual(add(-5, 10), 5)
        # Check that calling 'add(10, 10)' DOES NOT returns 20.
        self.assertNotEqual(add(10, 10), 30)
